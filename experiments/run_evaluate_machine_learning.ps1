...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\Galaxy-SIII\machine_learning.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\Galaxy-SIII\machine_learning.bow `
...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\Iphone-5\machine_learning.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\Iphone-5\machine_learning.bow `
...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\O-Apanhador-no-Campo-de-Centeio\machine_learning.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\O-Apanhador-no-Campo-de-Centeio\machine_learning.bow `
...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\O-Outro-Lado-da-Meia-Noite\machine_learning.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\O-Outro-Lado-da-Meia-Noite\machine_learning.bow `
