python .\SemOpinionS.py -m DohareEtAl2018_TF `
    ...
    -o ..\Resultados\out_DohareEtAl2018_TF_corpus_generico\O-Apanhador-no-Campo-de-Centeio
...
python .\SemOpinionS.py -m DohareEtAl2018_TF `
    ...
    --tfidf ..\Corpora\Reviews\b2w-reviews01_ReLi `
    -o ..\Resultados\out_DohareEtAl2018_TF_corpus_generico\Iphone-5
...
python .\SemOpinionS.py -m DohareEtAl2018_TF `
    ...
    --tfidf ..\Corpora\Reviews\b2w-reviews01_ReLi `
    -o ..\Resultados\out_DohareEtAl2018_TF_corpus_generico\O-Outro-Lado-da-Meia-Noite
...
python .\SemOpinionS.py -m DohareEtAl2018_TF `
    ...
    --tfidf ..\Corpora\Reviews\b2w-reviews01_ReLi `
    -o ..\Resultados\out_DohareEtAl2018_TF_corpus_generico\Galaxy-SIII
