...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\Galaxy-SIII\score_optimization.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\Galaxy-SIII\score_optimization.bow `
...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\Iphone-5\score_optimization.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\Iphone-5\score_optimization.bow `
...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\O-Apanhador-no-Campo-de-Centeio\score_optimization.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\O-Apanhador-no-Campo-de-Centeio\score_optimization.bow `
...
.\evaluation\evaluate_amr.ps1 `
    -test .\out\O-Outro-Lado-da-Meia-Noite\score_optimization.amr `
...
.\evaluation\evaluate_bow.ps1 `
    -test .\out\O-Outro-Lado-da-Meia-Noite\score_optimization.bow `
