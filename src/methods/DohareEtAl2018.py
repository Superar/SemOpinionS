...
open_ie_path = 'D:\\Documentos\\Mestrado\\Pesquisa\\Corpora\\OpenIEOut'
...
#     path = os.path.join(open_ie_path, prod, doc) + '.csv'
#     triples = OpenIE.read_csv(path).get_triples(int(sent)+1)

#     path_concepts = [corpus[sent_id].amr[c]['label'] for c in path]
#     print(path_concepts)
